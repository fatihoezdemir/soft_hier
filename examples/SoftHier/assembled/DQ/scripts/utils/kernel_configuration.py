...
def generate_config_C_header(header_prefix, config, C_header_file, dtype, numerical_check,vq_enabled, appendix=None):
    ...
    with open(C_header_file, 'w') as file:
        ...
        if dtype == 'fp16':
            ...
            if numerical_check == 1:
                ...
                file.write(f'#define COLLECTIVE_REDSUM_TYPE      COLLECTIVE_REDADD_FP_16\n')
                file.write(f'#define COLLECTIVE_REDMAX_TYPE      COLLECTIVE_REDADD_FP_16\n')
        elif dtype == 'fp8':
