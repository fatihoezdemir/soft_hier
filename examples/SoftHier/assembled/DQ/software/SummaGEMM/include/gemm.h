...
#define VQ_NUM_CBS 2
#define VQ_NBITS_PER_CB 8
#define VQ_GROUP_SIZE 8
#define VQ_CB_NUM_CENTROIDS 256
#define VQ_IDX_BYTES (1)
#define VQ_CB_BYTES 2
...
#define VQ_USE_SCALES 1
#define VQ_NUM_SCALES 512
#define VQ_CODEBOOK_FORMAT_FP16
#define VQ_INDEX_FORMAT_SEPARATE
#define STR(x) #x
#define XSTR(x) STR(x)
